...
const mockTasks = [
  { title: "Math Chapter 5", tag: "Class 10", priority: "High", col: "Done" },
  { title: "Physics Lab Report", tag: "Science", priority: "Medium", col: "In Progress" },
  { title: "English Essay", tag: "Arts", priority: "Low", col: "To Do" },
];
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-6 md:px-12 lg:px-20 w-full">
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            >
              A unified role-based workspace for teachers to create assignments and
              students to submit coursework — all tailored for your institution.
            </motion.p>
            ...
            >
              {["Role-Based Access", "Assignment Grading", "Student Submissions"].map((item) => (
            ...
            <div className="relative">
              ...
              <div className="relative rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-xl p-5 shadow-2xl">
                ...
                <div className="flex items-center justify-between mb-5">
                  ...
                  <span className="text-xs text-white/30 font-mono">onnorokom / assignments</span>
                </div>
