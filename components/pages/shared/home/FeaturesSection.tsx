...
const features = [
  {
    ...
    title: "Teacher Tools",
    description:
      "Create, update, and publish assignments for specific classes and subjects. Track all student submissions and manage deadlines effortlessly.",
  },
  {
    icon: Pencil,
    ...
    description:
      "View assigned coursework, submit answers before the deadline, and easily track your assignment status, marks, and teacher feedback.",
  },
  {
    icon: CalendarDays,
    color: "text-blue-400",
    ...
    title: "Admin Control",
    description:
      "Manage users, classes, and subjects. Assign teachers to specific courses and oversee the entire application's settings and data.",
  },
];
