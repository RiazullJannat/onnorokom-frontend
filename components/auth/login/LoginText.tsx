...
const features = [
  { icon: Layers, color: "text-yellow-400 bg-yellow-400/10", label: "Role-Based Access", desc: "Admin, Teacher, Student roles" },
  { icon: Pencil, color: "text-purple-400 bg-purple-400/10", label: "Assignment Creation", desc: "Set topics, deadlines & marks" },
  { icon: CalendarDays, color: "text-blue-400 bg-blue-400/10", label: "Student Submissions", desc: "Submit work before deadlines" },
  { icon: ShieldCheck, color: "text-green-400 bg-green-400/10", label: "Secure Login", desc: "JWT-based session management" },
];
  ...
  return (
    <div className="flex flex-col justify-center space-y-8 lg:space-y-10 max-w-md mx-auto lg:mx-0 px-0 sm:px-4 w-full">
      ...
      <Link href="/" className="flex items-center gap-3">
        ...
        <span className="text-2xl font-bold text-white tracking-tight">OnnoRokom</span>
      </Link>
      ...
      <div className="space-y-4">
        ...
        <p className="text-[#9B98AE] text-base leading-relaxed">
          A complete ecosystem for teachers, students, and administrators to streamline coursework and grading.
        </p>
      </div>
