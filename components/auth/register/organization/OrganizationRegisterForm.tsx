        ...
        <div className="space-y-6">
          ...
          <div className="space-y-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-sm font-bold text-white/60 tracking-wide">OnnoRokom</span>
            </div>
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              >
                <option value="Student" className="bg-[#030115] text-white">Student</option>
                <option value="Teacher" className="bg-[#030115] text-white">Teacher</option>
                <option value="Admin" className="bg-[#030115] text-white">Admin</option>
              </select>
            </div>
