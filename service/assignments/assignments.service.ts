import { CreateAssignmentPayload, CreateAssignmentReviewPayload, TSubmissionStatus } from "@/types/assignments/assignments.type";
...
export const submitAssignmentReview = async (assignmentId: number | string, submissionId: number | string, data: CreateAssignmentReviewPayload) => {
    return await putData(`/submissions/${submissionId}/grade`, `/dashboard/assignments/${assignmentId}`, data);
}

export const updateAssignmentReview = async (assignmentId: number | string, submissionId: number | string, data: CreateAssignmentReviewPayload) => {
    return await putData(`/submissions/${submissionId}/grade`, `/dashboard/assignments/${assignmentId}`, data);
}
